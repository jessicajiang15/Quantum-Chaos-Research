...
(*Monitor[
diffarray=Table[NIntegrate[Re[f[x,p,0.1]-g[x,p,0.1]],{x,xmin+(i-1)*dx,xmin+i*dx},{p,pmin+(j-1)*dy,pmin+j*dy},Method\[Rule]{"AdaptiveMonteCarlo",MaxPoints\[Rule]10^7}],{i,1,nbox},{j,1,nbox}],i];*)
...
(*If[flag\[Equal]8,Print[supplyamount];
